angular.module("app").controller "CreateAssetController", ($scope, $location, $stateParams, $modal, Growl, BlockchainAPI, RpcService, Utils, Info, Blockchain, WalletAPI) ->
    ...
    $scope.create = ->
        ...
        maximum_supply = Utils.parseInt($scope.create_asset.maximum_supply)
        ...
        $modal.open
            ...
            resolve:
                ...
                action: ->
                    ->
                        WalletAPI.asset_create(asset.symbol, asset.name, $scope.name, asset.description, maximum_supply, precision, asset.memo, false).then (response) ->
                            Growl.notice "", "Asset '#{asset.symbol}' was created"
                            copy = angular.copy(asset)
                            copy.registration_date = new Date()
                            copy.maximum_supply = maximum_supply * precision
                            ...
                            $scope.create_asset.maximum_supply = "100,000,000"
