angular.module("app").controller "TransferController", ($scope, $stateParams, $modal, $q, $filter, Wallet, WalletAPI, Blockchain, Utils, Info, Growl, $mdDialog) ->
    Info.refresh_info()
    $scope.utils = Utils
    $scope.balances = []
